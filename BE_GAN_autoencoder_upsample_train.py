...
def Generator_Net():    
    ...
    GN_conv_10 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_9)
    GN_conv_10 = ELU()(GN_conv_10)
    
    GN_conv_10 = UpSampling2D()(GN_conv_10)
    
    GN_conv_11 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_10)
    GN_conv_11 = ELU()(GN_conv_11)
    GN_conv_12 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_11)
    GN_conv_12 = ELU()(GN_conv_12)
    
    GN_conv_12 = UpSampling2D()(GN_conv_12)
    
    GN_conv_13 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_12)
    GN_conv_13 = ELU()(GN_conv_13)
    GN_conv_14 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_13)
    GN_conv_14 = ELU()(GN_conv_14)
    
    GN_conv_14 = UpSampling2D()(GN_conv_14)
...
def Discriminator_Net():  
    ...
    DN_conv_10 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_9)
    DN_conv_10 = ELU()(DN_conv_10)
    
    DN_conv_10 = UpSampling2D()(DN_conv_10)
    
    DN_conv_11 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_10)
    DN_conv_11 = ELU()(DN_conv_11)
    DN_conv_12 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_11)
    DN_conv_12 = ELU()(DN_conv_12)
    
    DN_conv_12 = UpSampling2D()(DN_conv_12)
    
    DN_conv_13 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_12)
    DN_conv_13 = ELU()(DN_conv_13)
    DN_conv_14 = Conv2D(128, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_13)
    DN_conv_14 = ELU()(DN_conv_14)
    
    DN_conv_14 = UpSampling2D()(DN_conv_14)
...
for e in range(nb_epoch):
    ...
    GN.save_weights(('/home/zhaojian/Keras/GAN_APPLE/models/Generator/BE_GAN_autoencoder_upsample_train/'+'lr_'+str(lr)+'epoch_'+str(e)+'_GN'), True)
    DN.save_weights(('/home/zhaojian/Keras/GAN_APPLE/models/Discriminator/BE_GAN_autoencoder_upsample_train/'+'lr_'+str(lr)+'epoch_'+str(e)+'_DN'), True)
    ...
    imsave(('/home/zhaojian/Keras/GAN_APPLE/internal_results/BE_GAN_autoencoder_upsample_train/'+'lr_'+str(lr)+'epoch_'+str(e)+'_'+'28798_00390.png'), refined)
